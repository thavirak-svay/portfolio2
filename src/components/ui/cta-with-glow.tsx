// src/components/ui/cta-with-glow.tsx
// PURPOSE: Provides a Call to Action section with a glow effect.
// SCOPE: IS: Reusable CTA component. IS NOT: Directly handling form submissions.
"use client"
  ...
  return (
    <section className={cn("group relative overflow-hidden py-24 sm:py-32", className)}>
      <div className="relative z-10 mx-auto flex max-w-container flex-col items-center gap-6 text-center sm:gap-8">
        <h2 className="text-3xl font-semibold sm:text-5xl animate-appear">{title}</h2>
        <Button variant={action.variant || "default"} size="lg" className="animate-appear delay-100" asChild>
